jQuery(document).ready(function ($) {
    ...
    jQuery(".parent-list")
        .find("a:first")
        .append(
            " <span class='menu-nav-arrow'><i class='icon-angle-down'></i></span>"
        );
    ...
    jQuery(".box_icon").each(function () {
        ...
        if (
            box_icon.find(".icon_i > span").hasClass("icon_soft_r") ||
            ...
            box_icon.find(".box_text h3 > span").hasClass("icon_soft_r") ||
            box_icon.find(".box_text h3 > span").hasClass("icon_square") ||
            box_icon.find(".box_text h3 > span").hasClass("icon_circle")
        ) {
            if (
                icon_size > 80 &&
                box_icon.find(".box_text h3 > span > span").length == 1
            ) {
                var icon_size = 80;
            }
        ...
        if (icon_align == "left") {
            ...
            if (
                ...
                box_icon
                    .find(".box_text")
                    .css({ "padding-left": parseFloat(icon_size) + 25 + "px" });
            } else if (
    ...
    jQuery(".box_icon").each(function () {
        ...
        this_icon.hover(
            function () {
                var span_hover = this_icon
                    .find(".icon_i > span")
                    .attr("span_hover");
                if (span_hover != undefined) {
                    this_icon
                        .find(".icon_i > span")
                        .css({ "background-color": span_hover });
                } else {
                    var span_hover = this_icon
                        .find(".box_text h3 > span")
                        .attr("span_hover");
                ...
                var border_hover = this_icon
                    .find(".icon_i > span")
                    .attr("border_hover");
                if (border_hover != undefined) {
                    this_icon
                        .find(".icon_i > span")
                        .css({ "border-color": border_hover });
                } else {
                    var border_hover = this_icon
                        .find(".box_text h3 > span")
                        .attr("border_hover");
                ...
                if (this_icon.find(".button").length) {
                    var button_background_hover = this_icon
                        .find(".button")
                        .attr("button_background_hover");
                    var button_color_hover = this_icon
                        .find(".button")
                        .attr("button_color_hover");
            ...
            function () {
                ...
                if (this_icon.find(".button").length) {
                    var button_background = this_icon
                        .find(".button")
                        .attr("button_background");
                    var button_color = this_icon
                        .find(".button")
                        .attr("button_color");
    ...
    jQuery(".icon_i").each(function () {
        var this_icon = jQuery(this);
        if (
            !this_icon.parent().hasClass("box_icon") &&
            !this_icon.parent().parent().hasClass("box_icon") &&
            !this_icon.parent().parent().parent().hasClass("box_icon")
        ) {
            ...
            if (
                this_icon.find("> span").hasClass("icon_soft_r") ||
    ...
    jQuery("ul.tabs").tabs(".tab-inner-warp", {
        effect: "slide",
        fadeInSpeed: 100,
    });
    ...
    jQuery("ul.tabs li").each(function () {
        ...
        if (jQuery(this).parent().parent().hasClass("tabs-vertical")) {
            ...
            jQuery(this)
                .parent()
                .parent()
                .find("div.tab-inner-warp")
                .css({ "margin-left": tab_width + "px" });
        }
    });
        ...
        if (
            ...
            ul_list.find("ul li").hover(
                function () {
                    jQuery(this)
                        .find("i")
                        .css({ "background-color": list_background_hover });
                },
                function () {
                    jQuery(this)
                        .find("i")
                        .css({ "background-color": list_background });
                }
            );
        }
    ...
    jQuery(".testimonial-warp").each(function () {
        ...
        testimonial
            ...
            .css({ "border-top-color": testimonial_border });
        testimonial
            .find(".testimonial-l-arrow")
            .css({ "border-top-color": testimonial_background });

        testimonial
            .find(".testimonial-client > span")
            .css({ color: client_color });
        testimonial
            .find(".testimonial-client > span > span")
            .css({ color: jop_color });
    });
        ...
        if (callout_warp.find(".button_right").length == 1) {
            callout_warp
                ...
                .css(
                    "margin-right",
                    parseFloat(
                        callout_warp.find(".button_right").outerWidth()
                    ) + 25
                );
            var button_css_top =
                parseFloat(callout_warp.innerHeight()) / 2 -
                parseFloat(callout_warp.find(".button_right").innerHeight()) /
                    2;
    ...
    ).prettyPhoto(lightboxArgs);

    jQuery("a[class^='prettyPhoto'], a[rel^='prettyPhoto']").prettyPhoto(
        lightboxArgs
    );
    ...
    jQuery(window).load(function () {
        ...
        jQuery(".carousel-all").each(function () {
            ...
            if ($current.hasClass("testimonial-carousel")) {
                ...
                $current
                    .find(".testimonial-warp")
                    .css("width", $testimonial_width);
            }
                ...
                .carouFredSel({
                    ...
                    scroll: {
                        ...
                        fx:
                            ...
                            ($effect == "cover-fade" ? "cover-fade" : "") +
                            ($effect == "fade" ? "fade" : "") +
                            ($effect == "directscroll" ? "directscroll" : "") +
                            ($effect == "crossfade" ? "crossfade" : "") +
                            ($effect == "cover" ? "cover" : "") +
                            ($effect == "uncover" ? "uncover" : "") +
                            ($effect == "uncover-fade" ? "uncover-fade" : "") +
                            ($effect == "none" ? "none" : ""),
                    },
                    items:
                        ($max == 6 ? 6 : "") +
    ...
    var header = parseFloat(
        jQuery("#header-top").outerHeight() +
            jQuery("#header").outerHeight() +
            jQuery(".breadcrumbs").outerHeight() +
            70
    );
    var footer = parseFloat(
        jQuery("#footer").outerHeight() +
            jQuery("#footer-bottom").outerHeight() +
            80
    );
        ...
        .bind("scroll resize", function () {
            ...
            if (scrollTop < header) {
                ...
                if (jQuery("#wrap").hasClass("fixed-enabled")) {
                    $widget_menu.css({
                        top: parseFloat(
                            jQuery(".fixed-nav").outerHeight() + 40
                        ),
                        bottom: "auto",
                    });
                } else {
